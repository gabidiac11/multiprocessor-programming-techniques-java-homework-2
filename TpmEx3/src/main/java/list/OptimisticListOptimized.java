 ...
 */
public class OptimisticListOptimized<T> implements IOptimisticList<T> {
    /**
     * First list entry
     */
    private Node head;
     ...
     * Constructor
     */
    public OptimisticListOptimized() {
    ...
    public boolean add(T item) {
        ...
        while (true) {
            ...
            int previousVersion = version.get();

            pred.lock(); current.lock();
            try {
                if (previousVersion == version.get() || validate(pred, current)) {
